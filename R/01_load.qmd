...
## Load the two GEO expression datasets
...
gse5620 <- read.delim(
  "/net/pupil1/home/people/s243690/group08_project/Group08_project/_raw/data/GSE5620_series_matrix.txt.gz",
  header = TRUE,
  sep = "\t",
  comment.char = "!",
  row.names = 1
...
gse5621 <- read.delim(
  "/net/pupil1/home/people/s243690/group08_project/Group08_project/_raw/data/GSE5621_series_matrix.txt.gz",
  header = TRUE,
  sep = "\t",
  comment.char = "!",
  row.names = 1
...
## 2. Create condition labels for each dataset and combine athem in the same order as columns
...
## 3. Combine both expression matrices side-by-side
...
```{r}
# final_sample_expression.csv contains:
# one row per sample
